...
struct Vector3 gPortalOutline[PORTAL_LOOP_SIZE] = {
    {0.0f, 1.0f * SCENE_SCALE *PORTAL_COVER_HALF_HEIGHT, 0},
    {0.353553f * SCENE_SCALE * PORTAL_COVER_WIDTH, 0.707107f * SCENE_SCALE *PORTAL_COVER_HALF_HEIGHT, 0},
...
void portalCalculateBB(struct Transform* portalTransform, struct Box3D* bb) {
    ...
    vector3Scale(&portalUp, &nextDir, PORTAL_COVER_HALF_HEIGHT * 0.5f);
