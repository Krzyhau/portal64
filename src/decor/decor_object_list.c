...
struct DecorObjectDefinition gDecorObjectDefinitions[] = {
    ...
    [DECOR_TYPE_LASER_EMITTER] = {
        ...
        0.0f,
        1.0f,
        PROPS_LASER_EMITTER_DYNAMIC_MODEL,
        .materialIndex = LASER_EMITTER_INDEX,
        .soundClipId = -1,
        .soundFizzleId = -1,
    },
    [DECOR_TYPE_LASER_CATCHER] = {
        {
            CollisionShapeTypeNone,
            NULL,
            0.0f,
        ...
        0.0f,
        1.0f,
        PROPS_LASER_CATCHER_DYNAMIC_MODEL,
        .materialIndex = LASER_CATCHER_INDEX,
        .materialIndexPowered = LASER_CATCHER_ACTIVATED_INDEX,
        .soundClipId = -1,
        .soundFizzleId = -1,
    },
    [DECOR_TYPE_LASER_CUBE] = {
        {
            CollisionShapeTypeBox,
            &gCubeCollisionBox,
            0.0f,
        ...
        2.0f,
        0.55f,
        CUBE_LASER_CUBE_DYNAMIC_MODEL,
        .materialIndex = LASER_CUBE_INDEX,
        .materialIndexFizzled = CUBE_FIZZLED_INDEX,
        .materialIndexPowered = LASER_CUBE_ACTIVATED_INDEX,
        .soundClipId = -1,
        .soundFizzleId = -1,
        .flags = DecorObjectFlagsImportant,
    },
